...
import com.sayem.accounts.dto.ErrorResponseDto;
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("sayem-correlation-id") String correlationId,
